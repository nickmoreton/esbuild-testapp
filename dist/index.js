...
(() => {
  ...
  // src/header/logo.png
  var logo_default = "./logo-4AP7VWLX.png";

  // src/header/add.png
  var add_default = "./add-JNXL5IXA.png";

  // src/header/header.js
  var header = document.createElement("div");
  header.className = "header";
  header.innerHTML = header_default;
  header.querySelector(".app-logo").setAttribute("src", logo_default);
  header.querySelector(".add-icon").setAttribute("src", add_default);
